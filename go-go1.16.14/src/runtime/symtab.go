...
type funcID uint8 // 注释：方法ID

// 注释：特殊方法的ID预设值
const (
	funcID_normal                funcID = iota // 注释：不是一个特殊方法 // not a special function
	funcID_runtime_main                        // 注释：runtime.main 方法
	funcID_goexit                              // 注释：runtime.goexit 方法
	funcID_jmpdefer                            // 注释：runtime.jmpdefer 方法
	funcID_mcall                               // 注释：runtime.mcall 方法
	funcID_morestack                           // 注释：runtime.morestack 方法
	funcID_mstart                              // 注释：runtime.mstart 方法
	funcID_rt0_go                              // 注释：runtime.rt0_go 方法
	funcID_asmcgocall                          // 注释：runtime.asmcgocall 方法
	funcID_sigpanic                            // 注释：runtime.sigpanic 方法
	funcID_runfinq                             // 注释：runtime.runfinq 方法
	funcID_gcBgMarkWorker                      // 注释：runtime.gcBgMarkWorker 方法
	funcID_systemstack_switch                  // 注释：runtime.systemstack_switch 方法
	funcID_systemstack                         // 注释：runtime.systemstack 方法
	funcID_cgocallback                         // 注释：runtime.cgocallback 方法
	funcID_gogo                                // 注释：runtime.gogo 方法
	funcID_externalthreadhandler               // 注释：runtime.externalthreadhandler 方法
	funcID_debugCallV1                         // 注释：runtime.debugCallV1 方法
	funcID_gopanic                             // 注释：runtime.gopanic 方法
	funcID_panicwrap                           // 注释：runtime.panicwrap 方法
	funcID_handleAsyncEvent                    // 注释：runtime.handleAsyncEvent 方法
	funcID_asyncPreempt                        // 注释：runtime.asyncPreempt 方法
	funcID_wrapper                             // 注释：译：任何自动生成的代码（hash/eq算法、方法包装器等） // any autogenerated code (hash/eq algorithms, method wrappers, etc.)
)
